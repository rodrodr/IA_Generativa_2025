...
¿Te has dado cuenta que todos los modelos de IA tienen nombres "curiositos": Gemma, RoBERTa, Claude, DeepSeek? Para no perder la "vibe", hemos decidido llamar a este curso GenIA. ¿De qué se trata? A día de hoy, resulta difícil encontrar a alguien que NO utiliza chatGPT o alguna alternativa para tareas cotidianas. Algunas personas piden "deseos" como "escríbeme un mail", "tradúceme al inglés", o "corrígeme la ortografía de este texto". Por lo tanto, no resulta nada nuevo. Basta imaginar y saber pedir.
...
>>
>> El barbudo de la gorra en las camisetas
